...
#define COM_INITFLAGS ::COINIT_APARTMENTTHREADED | ::COINIT_DISABLE_OLE1DDE
    ...
    /* includes nullptr terminator byte in return */
    ...
    nfdresult_t OpenDialog(std::wstring& outPath_wchar, const nfdchar_t* filterList, const nfdchar_t* defaultPath)
    {
    ...
    nfdresult_t SaveDialog(std::wstring& outPath_wchar, const nfdchar_t* filterList, const nfdchar_t* defaultPath)
    {
        nfdresult_t nfdResult = NFD_ERROR;
    ...
    nfdresult_t PickFolder(std::wstring& outPath_wchar, const nfdchar_t* defaultPath)
    {
        nfdresult_t nfdResult = NFD_ERROR;
        DWORD dwOptions = 0;
